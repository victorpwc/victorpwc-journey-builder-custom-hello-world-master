...
// , these can be stored in a separate file using a module like config
 var APIKeys = {
        appId           : 'e426ecc2-1a12-4258-928d-6d73c4084e0f',
        clientId        : 'des2en7lo0uujmseiofeqpke',
        clientSecret    : 'cX0NqEW09nS7J5MvG4jXUP85',
        appSignature    : 'g5iybjld1liwxkhr3xul3dml5crvt4a1a0dnde1jumkku4zi2ydp2r5yjklhtzomfo0b5mj5itmsia2sqzyk3e52fn2uijqlpzjrjctqryay4npkosnsrkhgojafy1gs52sung12temjemur2kfygdtbb25cau300cum3dkmusf4z0b5t0dhs2ta2uwqiszm5q04abjyoj13lbmhq1o022qtb25fejy2vgyfkmjgtqwgbwn0urohbrbsgpdrfg1',
...
app.post('/fireEvent/:type', function( req, res ) {
    var data = req.body;
    var triggerIdFromAppExtensionInAppCenter = 'jb-hello-world-trigger-vlf';
